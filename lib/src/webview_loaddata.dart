...
class WebviewLoadData extends StatefulWidget {

  const WebviewLoadData({
    Key key,
    this.appBar,
    @required this.url,
    this.headers,
  ...
  @override
  _WebviewLoadDataState createState() => _WebviewLoadDataState();
}

class _WebviewLoadDataState extends State<WebviewLoadData> {
