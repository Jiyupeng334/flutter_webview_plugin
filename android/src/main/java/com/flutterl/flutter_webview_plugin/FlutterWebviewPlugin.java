package com.flutterl.flutter_webview_plugin;
...
public class FlutterWebviewPlugin implements MethodCallHandler, PluginRegistry.ActivityResultListener {
  ...
  private void loadData(MethodCall call, Result result) {
    boolean hidden = call.argument("hidden");
    String contentData=call.argument("data");
    ...
    webViewManager.loadData(withJavascript,
            clearCache,
            hidden,
            clearCookies,
            contentData,
